...
Sanal_k1_1e_8(i17)=(1/Qanal_k1_1e_8(i17))*(Qanal_k1_1e_8_delta(i17)-Qanal_k1_1e_8(i17))/delta;
...
Sanal_k1_1e_6(i17)=(1/Qanal_k1_1e_6(i17))*(Qanal_k1_1e_6_delta(i17)-Qanal_k1_1e_6(i17))/delta;
...
Sanal_k1_1e_4(i17)=(1/Qanal_k1_1e_4(i17))*(Qanal_k1_1e_4_delta(i17)-Qanal_k1_1e_4(i17))/delta;
...
plot(tflin/(365*24*3600),Sanal_k1_1e_8,'-cx','LineWidth',1.5,'MarkerIndices',1:22:length(tflin))
% plot(tflin/(365*24*3600),Sanal_k1_1e_6,'--msquare','LineWidth',1.5,'MarkerIndices',1:27:length(tflin))
% plot(tflin/(365*24*3600),Sanal_k1_1e_4,'-.y^','LineWidth',1.5,'MarkerIndices',1:32:length(tflin))
hold off
...
plot(tflin/(365*24*3600),Qanal_k1_1e_8,':msquare','LineWidth',1.5,'MarkerIndices',1:30:length(tflin));
hold off
% ylim([0 0.18])
